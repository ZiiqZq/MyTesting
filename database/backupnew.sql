...
CREATE TABLE `product_test_parameters` (
  ...
  `parameter_unit` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lsl` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `usl` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `validation_type` enum('lsl_usl','pass_fail','reference') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'lsl_usl',
...
-- Dump completed on 2026-01-05  1:48:31
